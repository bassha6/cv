export default function Testimonials() {
    return (
      <div className="mt-10 sm:mt-14">
        <h2 className="mb-3 font-medium text-gray-800 ">
          Testimonials
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-3 border-y border-gray-200 divide-y sm:divide-y-0 sm:divide-x divide-gray-200 dark:border-neutral-700 dark:divide-neutral-700">
            ...
            <blockquote>
              ...
              <footer className="mt-3">
                <div className="flex items-center gap-x-2">
                  ...
                  <div className="grow">
                    <div className="text-xs text-gray-500 ">Josh Grazioso</div>
                  </div>
                </div>
              </footer>
            </blockquote>
          ...
          <div className="py-6 sm:px-4">
            <blockquote>
              <span className="text-sm text-gray-800 ">To say that hiring Eliana has been life-changing is an understatement. My business has tripled and I got my life back.</span>
              <footer className="mt-3">
                <div className="flex items-center gap-x-2">
                  <img className="shrink-0 size-5 rounded-full" src="/placeholder.svg?height=20&width=20" alt="Avatar" />
                  <div className="grow">
                    <div className="text-xs text-gray-500 ">Nicole Grazioso</div>
                  </div>
                </div>
              </footer>
            </blockquote>
